package com.github.heroslender.hero_api.persistence;
...
public class MockEntityManager implements EntityManager {
    public static final EntityManager INSTANCE = new MockEntityManager();
    ...
    public <T> T getReference(Class<T> entityClass, Object primaryKey) {
        if (entityClass == UserEntity.class) {
            ...
            entity.setId((Long) primaryKey);
            return (T) entity;
        } else if (entityClass == PluginEntity.class) {
            PluginEntity entity = new PluginEntity();
            entity.setId((String) primaryKey);
            return (T) entity;
        } else if (entityClass == PluginLicenceEntity.class) {
            PluginLicenceEntity entity = new PluginLicenceEntity();
            entity.setId((UUID) primaryKey);
            return (T) entity;
        } else if (entityClass == PluginVersionEntity.class) {
